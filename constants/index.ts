...
export const serviceDescriptions: Record<string, string> = {
    landscaping: "The advantage: perfecting this one outdoors carefully nurtured location. Our landscape services ensure a garden to revitalize any property...",
    hardscaping: "Hardscaping forms the backbone of your outdoor living space. We design and install patios, retaining walls, and more...",
    fencing: "Keep your property secure and stylish with our fencing options...",
    lighting: "Brighten your nights and highlight key features with our landscape lighting solutions...",
    irrigation: "Efficient irrigation systems to keep your lawn healthy and green...",
    others: "From garden makeovers to specialty projects, we handle a wide range of other services...",
  };
  
export const landscapingDetailItems = [
    { title: "Soil", content: "We offer soil amendments, topsoil, and more to ensure a healthy foundation for your plants." },
    { title: "Artificial Turf", content: "Low-maintenance, water-saving artificial turf that looks great year-round." },
    { title: "Edging, Mulching, Rock", content: "Create clean boundaries and protect roots with edging, mulch, or decorative rock." },
    { title: "Planting", content: "From flower beds to shrubs and trees, we handle all your planting needs." },
];
  
export const hardscapingDetailItems = [
    { title: "Patios", content: "Elegant patio designs that expand your outdoor living space." },
    { title: "Retaining Walls", content: "Durable retaining walls to secure slopes and add character." },
    { title: "Walkways", content: "Beautiful walkways that guide your outdoor journey." },
    { title: "Outdoor Kitchens", content: "Fully-equipped outdoor kitchens for seamless entertaining." },
];
